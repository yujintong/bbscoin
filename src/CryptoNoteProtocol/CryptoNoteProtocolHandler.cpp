...
bool CryptoNoteProtocolHandler::on_connection_synchronized() {
  ...
  if (m_synchronized.compare_exchange_strong(val_expected, true)) {
    logger(Logging::INFO) << ENDL << "**********************************************************************" << ENDL
      << "You are now synchronized with the BBSCoin network. You may now start simplewallet." << ENDL
      << ENDL
      ...
      << ENDL
      << "Use \"help\" command to see the list of available commands. For more information, you can check https://bbscoin.click/" << ENDL
      << "**********************************************************************";
