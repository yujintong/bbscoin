...
public:
  ...
  virtual std::string message(int ev) const {
    ...
    switch (code) {
      ...
      case BlockValidationError::WRONG_VERSION: return "Wrong block version. Please check if there is a new version from https://bbscoin.click";
      case BlockValidationError::ILLEGAL_PARENT_BLOCK: return "Illegal block structure. Please use supported pool software from https://github.com/bbscoincommunity/bbscoin-pool";
